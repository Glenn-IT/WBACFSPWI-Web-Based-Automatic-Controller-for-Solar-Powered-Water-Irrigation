...
| **JSN-SR04T Ultrasonic (Surface Level)** | `A1` (TRIG)<br>`A4` (ECHO) | `28.0cm` (Floor / 0%) | `20.0cm` (Full / 100%) | Clearance: `20.0cm`<br>Depth: `8.0cm`<br>50% Target: `24.0cm`<br>40% Refill: `24.8cm` | `10_gsm_sms_irrigation_alert_test`<br>`11_jsn_sr04t_ultrasonic_water_level_test`<br>`wbacfspwi_arduino_controller` |
...
| 2026-09-19 | JSN-SR04T Ultrasonic (A1/A4) | `24.4cm` (Soil Bed 0%) | `20.4cm` (Full 100%) | Calibrated: Soil Bed=24.4cm (0%), 50% target=22.4cm (depth 2.0cm), 40% refill=22.8cm (depth 1.6cm), usable depth=4.0cm, clearance=20.4cm. |
| 2026-09-21 | JSN-SR04T Ultrasonic (A1/A4) | `28.0cm` (Soil Bed 0%) | `20.0cm` (Full 100%) | Container Change Re-calibration: Soil Bed=28.0cm (0%), 50% target=24.0cm (depth 4.0cm), 40% refill=24.8cm (depth 3.2cm), 100% full=20.0cm (depth 8.0cm), usable depth=8.0cm, clearance=20.0cm. All sketches synced. |
