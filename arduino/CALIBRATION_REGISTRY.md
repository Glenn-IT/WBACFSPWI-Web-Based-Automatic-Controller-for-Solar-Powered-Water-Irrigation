...
| **JSN-SR04T Ultrasonic (Surface Level)** | `A1` (TRIG)<br>`A4` (ECHO) | `26.0cm` (Floor / 0%) | `18.8cm` (Full / 100%) | Clearance: `18.8cm`<br>Depth: `7.2cm`<br>50% Target: `22.4cm`<br>45% Refill: `22.8cm` | `11_jsn_sr04t_ultrasonic_water_level_test`<br>`wbacfspwi_arduino_controller` |
...
| 2026-09-19 | JSN-SR04T Ultrasonic (A1/A4) | `26.0cm` (Base 0%) | `18.8cm` (Full 100%) | Calibrated: Base=26.0cm (0%), 50% target=22.4cm (depth 3.6cm), 45% refill=22.8cm (depth 3.24cm), usable depth=7.2cm, clearance=18.8cm. Zero jitter, 100% stable reflection. |
