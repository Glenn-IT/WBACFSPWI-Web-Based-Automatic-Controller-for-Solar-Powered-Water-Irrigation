...
| **HW-080 (Surface Ponding Level)** | `A1` | `1020` (Air / 0%)<br>`410` (Mid / 50%) | `270` (Full / 100%) | 3-Point Physical Ruler Calibration | `02_surface_water_level_test`<br>`07_dual_sensor_pump_integration_test`<br>`wbacfspwi_arduino_controller` |
...
| 2026-08-31 | HW-080 Surface (A1) | `1020` (Air)<br>`410` (Middle 50%) | `270` (Full 100%) | 3-Point physical ruler calibration: 1020=0% (dry air), 410=50.0% (exact middle/7-8cm), 270=100.0% (top header). Directly aligns with physical ruler height. |
