...
// - Dry Soil Bed / Empty Floor Distance = 27.8 cm (Depth: 0.0 cm, Level: 0.0%)
// - 50.0% Target Water Level Distance  = 22.4 cm (Depth: 5.4 cm, Level: 50.0%) -> Pump OFF
// - 45.0% Refill Water Level Distance  = 22.9 cm (Depth: 4.86 cm, Level: 45.0%) -> Pump ON
// - Total Usable Container Depth (100% scale) = 10.8 cm (5.4 cm * 2)
// - Sensor Clearance (Transducer to 100% mark) = 17.0 cm (27.8 cm - 10.8 cm)
