...
| **SIG-07** | JSN-SR04T ECHO Pin | Direct Jumper | Arduino Pin A4 | **Blue** | 5V Digital In | Ultrasonic echo pulse duration (Time-of-Flight distance). Calibrated: 28.0cm (0%), 24.0cm (50%), 24.8cm (40%), 20.0cm (100%). |
