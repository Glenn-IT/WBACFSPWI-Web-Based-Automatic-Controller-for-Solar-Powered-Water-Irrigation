...
| **SIG-04** | HW-080 Sensor AO | Direct Jumper | Arduino Pin A1 | **Cyan** | 0V – 5.0V Analog | Surface ponding depth controller (Dry ~1019, Wet ~508). Maintains 85% level (ON < 80%, OFF $\ge$ 85%). |
