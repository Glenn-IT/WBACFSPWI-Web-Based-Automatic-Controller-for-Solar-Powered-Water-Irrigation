...
| **GSM Module SMS Alert System** | `arduino/10_gsm_sms_irrigation_alert_test/` | • `arduino/10_gsm_sms_irrigation_alert_test/10_gsm_sms_irrigation_alert_test.ino`<br>• `arduino/10_gsm_sms_irrigation_alert_test/wiring_guide.html`<br>• `arduino/Pinout_and_Schematic.md`<br>• `SYSTEM_MEMORY.md` | Board: SIM800L / SIM900 GSM/GPRS Module<br>Pins: Arduino D2 (RX) <- GSM TXD; Arduino D3 (TX) -> GSM RXD via 1k/2k divider<br>Power: 3.7V - 4.4V (4.0V nominal, 2A burst) + 1000µF buffer cap<br>Automated SMS triggers: Irrigation Started (<45%), Stopped (>=50%), and Restarted (<45% again) |
